package com.github.taosoft.bookstore.security.provider;

import com.github.taosoft.bookstore.infrastructure.security.JWTAccessToken;
 ...
 * <p>
 * 在Infrastructure工程中提供了{@link com.github.taosoft.bookstore.infrastructure.security.RSA256PublicJWTAccessToken}作为公钥验证用途。
 * 为了便于对比，
 **/
@Named
@Primary
public class RSA256JWTAccessToken extends JWTAccessToken {
    ...
    RSA256JWTAccessToken(UserDetailsService userDetailsService) {
        ...
        setKeyPair(keyStoreKeyFactory.getKeyPair("taosoft-bookstore-rsa"));
    }
